...
- **SQL 활용 능력단위** 
- 테이블 간의 관계를 고려하여 **데이터베이스 구현**
관계 구성 시 정규화를 통해 데이터 중복을 최소화하였고, SQL 활용 능력단위에서 배운 DML(INSERT, UPDATE, DELETE, SELECT) 문법을 사용하여 더미 데이터를 추가·수정·삭제·조회하며 동작을 검증했습니다.
...
- HTML, CSS, JS를 활용하여 **화면 구현**
- JS로 유효성 검사 등 동적 이벤트 구현
&nbsp;
